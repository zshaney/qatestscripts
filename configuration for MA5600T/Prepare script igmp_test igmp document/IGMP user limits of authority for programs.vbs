...
'mvlan
	...
	crt.Screen.Send "y" & chr(13)
	crt.Screen.Send "igmp program add ip 225.4.4.4 name program1" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "igmp program add ip 225.5.5.5 name program2" & chr(13)
	crt.Screen.Send chr(13)
	
'add user
    crt.Screen.Send "btv" & chr(13)
    crt.Screen.Send "igmp profile add profile-name qa1" & chr(13)
	crt.Screen.Send "igmp profile add profile-name qa2" & chr(13)
	crt.Screen.Send "igmp profile profile-name qa1 program-name program1 watch" & chr(13)
	crt.Screen.Send "igmp profile profile-name qa2 program-name program2 forbidden" & chr(13)
	crt.Screen.Send "igmp user add service-port " & Srvport & " auth" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "multicast-vlan 1000" & chr(13)
	crt.Screen.Send "igmp multicast-vlan member service-port " & Srvport & " " & chr(13)
	crt.Screen.Send "btv" & chr(13)
	crt.Screen.Send "igmp user bind-profile service-port " & Srvport & " profile-name qa1" & chr(13)
	crt.Screen.Send "igmp user bind-profile service-port " & Srvport & " profile-name qa2" & chr(13)
	crt.Screen.Send "quit" & chr(13)
