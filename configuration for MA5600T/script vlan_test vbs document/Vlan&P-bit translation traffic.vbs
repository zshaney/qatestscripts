...
'Create cvlan(vid=150&pbit1=1) to translate to correspongding user-vlan(vid=300&pbit=2) on the DUT port. 
'Create a ont-srvprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 translation 300 2 user-vlan 150 1" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)
