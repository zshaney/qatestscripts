...
'Configure cvlan(vid=150) and qinq vlan based on native vlan and priority (vid=300&pbit=3) assigned on the DUT port.  	
	crt.Screen.Send "port vlan eth 1 150" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 300" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "port priority-policy eth 1 assigned" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)
	crt.Screen.Send "interface gpon 0/6" & chr(13)
