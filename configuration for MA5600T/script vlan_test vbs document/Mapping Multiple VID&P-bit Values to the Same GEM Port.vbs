...
'Create a gem mapping rule that mapping traffic with different tag (vid1=100&pbit1=1,vid2=200&pbit2=2) to gem port1 
'Create a ont-lineprofile 
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "gem mapping 1 2 vlan 200 priority 1" & chr(13)
	crt.Screen.Send chr(13)
...
'Configure traffic with different user-vlan (vid1=100,vid2=200) transparent to them corresponding svlan (vid1=100,vid2=200) expectively both from GEM port1.
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "service-port vlan 100 gpon 0/6/0 ont " & OntId & " gemport 1 multi-service user-vlan 200 tag-transform  transparent" & chr(13)
	crt.Screen.Send chr(13)
