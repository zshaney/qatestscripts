...
'OLT VLAN configuration		
	...
	crt.Screen.Send "vlan 400 smart" & chr(13)
	crt.Screen.Send "port vlan 400 0/19 " & UpstrPort & chr(13)
...
'Create a gem mapping rule that mapping traffic with particular tag (vid=400) to gem port1 
'Create a ont-lineprofile
	...
	crt.Screen.Send "gem mapping 1 1 vlan 400" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)

'Configure traffic with different user-vlan (vid=400) transparent to it corresponding svlan (vid=400) from GEM port1. 	
'Create a ont-srvprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 translation 400 user-vlan 200" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)
...
'Create cvlan(vid=200) to translate to it correspongding user-vlan(vid=400) on the DUT port. 
	crt.Screen.Send "service-port vlan 400 gpon 0/6/0 ont " & OntId & " gemport 1 multi-service user-vlan 400 tag-transform  transparent" & chr(13)
	crt.Screen.Send chr(13)
