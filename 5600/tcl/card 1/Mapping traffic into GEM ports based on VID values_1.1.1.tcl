...
for {set j 1} {$j <= 20} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     if {$typeField == $tarValue} {
            incr Flag3
	        ixPuts "It is expected that receiving a Vlan=100 Priority =2 upstream stream3."
	     break
	     } else { 
	           puts $typeField
	           incr Mark3
...
if {$Mark3 == 20} {
    ixPuts "error ! not receiving Vlan=100 Priority =2 upstream stream3"
}
...
for {set s 1} {$s <= 10} {incr s} {
	if { [captureBuffer getframe $s] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 11]
	     set tarValue [format "%s %s" $wan_da2 $wan_sa2]
	     if {$typeField == $tarValue} {
            ixPuts "error ! receiving downstream stream2."
	        puts $typeField
	        break
	     } else { 
	          incr Mark6
