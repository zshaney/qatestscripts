...
set wan_da2 "00 09 00 00 02 03"
set wan_sa2 "00 09 00 00 01 03"
...
for {set j 1} {$j <= 15} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 60 C8" $lan_da3 $lan_sa3 ]
	     if {$typeField == $tarValue} {
            incr Flag2
...
for {set r 1} {$r <= 10} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
		...
		set capFrame [captureBuffer cget -frame]
		set typeField [lrange $capFrame 0 15]
		set tarValue [format "%s %s 81 00 00 64" $wan_da1 $wan_sa1 ]
		if {$typeField == $tarValue} {
		   incr Flag5
