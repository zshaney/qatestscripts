	...
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	       ...
	       if {$typeField == $tarValue	} {
              incr Flag1
	          ixPuts "It is expected that receiving a Vlan=1000 Priority =1 upstream stream1 ."
	          break
	          } else { 
	                puts $typeField
	                incr Mark1
...
if {$Mark1 == 30} {
    ixPuts "error ! not receiving Vlan=1000 Priority =1 upstream stream1"
}
...
for {set j 1} {$j <= 30} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 07 D0" $lan_da2 $lan_sa2 ]
	     if {$typeField == $tarValue} {
            incr Flag2
	        ixPuts "It is expected that receiving a Vlan=2000 Priority =0 upstream stream2 ."
	        break
	     } else { 
	           puts $typeField
	           incr Mark2
...
if {$Mark2 == 30} {
    ixPuts "error ! not receiving Vlan=2000 Priority =1 upstream stream2"
}
...
for {set k 1} {$k <= 30} {incr k} {
	if { [captureBuffer getframe $k] } {
	   ...
	   break
	     ...
	     if {$typeField == $tarValue} {
            incr Flag3
	        ixPuts "It is expected that receiving a Vlan=1000 Priority =1 upstream stream3 ."
	        break
	     } else { 
		    puts $typeField
	        incr Mark3
...
if  {$Mark3 == 30} {
    ixPuts "error ! not receiving Vlan=1000 Priority =1 upstream stream3."
}
...
for {set m 1} {$m <= 30} {incr m} {
	if { [captureBuffer getframe $m] } {
	   ...
	   break
	     ...
	     if {$typeField == $tarValue} {
            incr Flag4
	        ixPuts "It is expected that receiving a Vlan=untag upstream stream4 ."
	        break
	     } else { 
	         puts $typeField
			 incr Mark4
...
if  {$Mark4 == 30} {
	...
	ixPuts "error ! not receiving Vlan=untag upstream stream4."
}
