...
for {set i 1} {$i <= 20} {incr i} {
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	      ...
	      set tarValue [format "%s %s 81 00 41 2C" $lan_da3 $lan_sa3 ]
		  if {$typeField == $tarValue	} {
             incr Flag1
	         ixPuts "It is expected that receiving a Vlan=300 Priority=2 upstream stream3 ."
	         break
	      } else { 
	             incr Mark1 
	             puts $typeField
...
if {$Mark1 == 20} {
    ixPuts "error ! not receiving a Vlan=300 Priority=2 upstream stream3"
}
