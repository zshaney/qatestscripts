...
for {set k 1} {$k <= 30} {incr k} {
	if { [captureBuffer getframe $k] } {
	   ...
	   break
	     ...
	     set tarValue [format "%s %s 81 00 21 2C 81 00 20 96" $lan_da1 $lan_sa1]
	     if {$typeField == $tarValue} {
            incr Flag1
	        ixPuts "It is expected that receiving a SVID=300 Spbit=1 ; CVID=150 Cpbit=1 upstream stream1 ."
	        break
	     } else { 
		    puts $typeField
	        incr Mark1
...
if  {$Mark1 == 30} {
    ixPuts "error ! not receiving SVID=300 Spbit=1 ; CVID=150 Cpbit=1 upstream stream1."
}
...
for {set k 1} {$k <= 30} {incr k} {
	if { [captureBuffer getframe $k] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 19]
	     set tarValue [format "%s %s 81 00 61 2C 81 00 20 96" $lan_da2 $lan_sa2]
	     if {$typeField == $tarValue} {
            incr Flag2
	        ixPuts "It is expected that receiving a SVID=300 Spbit=3 ; CVID=150 Cpbit=1 upstream stream2 ."
	        break
	     } else { 
		    puts $typeField
	        incr Mark2
...
if  {$Mark2 == 30} {
    ixPuts "error ! not receiving SVID=300 Spbit=3 ; CVID=150 Cpbit=1 upstream stream2."
}
...
for {set k 1} {$k <= 30} {incr k} {
	if { [captureBuffer getframe $k] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 19]
	     set tarValue [format "%s %s 81 00 A1 2C 81 00 20 96" $lan_da3 $lan_sa3]
	     if {$typeField == $tarValue} {
            incr Flag3
	        ixPuts "It is expected that receiving a SVID=300 Spbit=5 ; CVID=150 Cpbit=1 upstream stream3 ."
	        break
	     } else { 
		    puts $typeField
	        incr Mark3
...
if  {$Mark3 == 30} {
    ixPuts "error ! not receiving SVID=300 Spbit=5 ; CVID=150 Cpbit=1 upstream stream3."
}
