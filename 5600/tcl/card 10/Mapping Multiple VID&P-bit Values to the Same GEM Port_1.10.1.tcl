...
captureBuffer get $chassis $card $wanport 1 15
...
if {$Mark3 == 15} {
    ixPuts "error ! not receiving Vlan=200 Priority =2 upstream stream3"
}
...
captureBuffer get $chassis $card $lanport 1 15
...
for {set s 1} {$s <= 15} {incr s} {
	if { [captureBuffer getframe $s] } {
	   ...
	   break
		...
		if {$typeField == $tarValue} {
		   incr Flag6
		   ixPuts  "It is expected that receiving a Vlan=200 Priority =2 downstream stream2 ."
		   break
		} else { 
		     puts $typeField
		     incr Mark6
...
if {$Mark6 == 15} {
    ixPuts "error ! not receiving  Vlan=200 Priority =2 downstream stream2"
}
