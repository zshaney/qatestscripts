...
'Remove the old configuration	
	...
	crt.Screen.Send "traffic table ip index 11 cir 10240 cbs 20480 pir 20480 pbs 20480 color-policy cos priority 1 priority-policy tag-In-package" & chr(13)
	...
	crt.Screen.Send "traffic table ip index 13 cir 40960 cbs 40960 pir 81920 pbs 81920 color-policy cos priority 1 priority-policy tag-In-package" & chr(13)
...
'Create a ont-lineprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "gem add 1 eth tcont 1 gem-car 11" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "gem add 2 eth tcont 1 gem-car 12" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "gem add 3 eth tcont 1 gem-car 13" & chr(13)
	crt.Screen.Send chr(13)
