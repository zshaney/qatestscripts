...
'add profile
	...
	crt.Screen.Send "y" & chr(13)
	crt.Screen.Send "igmp mode snooping" & chr(13)
	crt.Screen.Send "y" & chr(13)
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "igmp program add name test ip 224.5.5.5" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "igmp multicast-vlan member service-port " & Srvport & chr(13)
	crt.Screen.Send "multicast-vlan 20" & chr(13)
	crt.Screen.Send "igmp program add name test ip 224.6.6.6" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "igmp multicast-vlan member service-port " & Srvport & chr(13)
	crt.Screen.Send "quit" & chr(13)
