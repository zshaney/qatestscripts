...
'Create a igmp program(group ip:224.4.4.4) in multicast-vlan 10 Then add corresponding igmp user and igmp multicast-vlan member on the OLT. 	
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "service-port " & Srvport1 & " vlan 10 gpon 0/6/0 ont " & OntId & " gemport 1 multi-service user-vlan 10" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "service-port " & Srvport2 & " vlan 10 gpon 0/6/0 ont " & OntId & " gemport 1 multi-service user-vlan 10" & chr(13)
	crt.Screen.Send chr(13)
...
'add profile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "igmp user add service-port " & Srvport1 & " no-auth max-program 8" & chr(13)
	crt.Screen.Send chr(13)	
	crt.Screen.Send "igmp user add service-port " & Srvport2 & " no-auth max-program 8" & chr(13)
	crt.Screen.Send chr(13)		
