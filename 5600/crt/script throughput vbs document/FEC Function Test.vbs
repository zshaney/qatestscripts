...
'Create a ont-lineprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "tcont 1 dba-profile-id 4" & chr(13)
	crt.Screen.Send chr(13)
...
'Configure traffic with particular user-vlan (vid=1000) transparent to it corresponding svlan (vid=1000) from GEM port1.	
	crt.Screen.Send "service-port vlan 1000 gpon 0/6/0 ont " & OntId & " gemport 1 multi-service user-vlan 1000" & chr(13)
	crt.Screen.Send chr(13)
