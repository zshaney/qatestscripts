...
'Configure traffic with particular user-vlan (vid=100) transparent to it corresponding svlan (vid=100) from GEM port1.	
'Create a ont-srvprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 translation 100 priority user-cos user-vlan 100 2" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 translation 100 priority user-cos user-vlan 100 7" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)
...
'Create cvlan(vid1=100&pbit1=2,vid1=100&pbit2=7) to translate to correspongding user-vlan (vid1=100&pbit1=2,vid1=100&pbit2=7) based on user-cos on the DUT port. 
