...
'Create a gem mapping rule that mapping traffic with different tag (vid1=100&pbit1=0,vid2=200&pbit2=1) to gem port1 
'Create a ont-lineprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "gem mapping 1 1 vlan 200" & chr(13)
	crt.Screen.Send chr(13)
...
'Create a ont-srvprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 translation 200 1 user-vlan 200 2" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)
