...
'Create a gem mapping rule that mapping traffic with different tag (vid1=100&pbit1=0,vid1=100&pbit2=1) to gem port1
...
'Create a ont-srvprofile
	...
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 translation 100 0 user-vlan 100 2" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "port vlan eth 1 translation 100 1 user-vlan 100 3" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)
...
'Create cvlan(vid1=100&pbit1=2,vid1=100&pbit2=3) to translate to correspongding user-vlan(vid1=100&pbit1=0,vid1=100&pbit2=1) expectively on the DUT port. 
