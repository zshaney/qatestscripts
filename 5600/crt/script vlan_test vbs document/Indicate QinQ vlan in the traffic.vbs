...
'Create a gem mapping rule that mapping traffic with particular tag (vid=300) to gem port1  
...
'Configure cvlan(vid=150) to qinq to correspongding user-vlan(stacked vid=300:150) on the DUT port. 
'Create a ont-srvprofile	
	...
	crt.Screen.Send chr(13)	
	crt.Screen.Send "port vlan eth 1 q-in-q 300 user-vlan 150" & chr(13)
	crt.Screen.Send chr(13)
	crt.Screen.Send "commit" & chr(13)
	crt.Screen.Send "quit" & chr(13)
