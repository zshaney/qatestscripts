...
Sub Main
	...
	crt.Screen.Send "configure vlan id stacked:300:0 mode residential-bridge" & chr(13)
	crt.Screen.Send "configure vlan id stacked:300:150 mode residential-bridge in-qos-prof-name name:Default_TC0" & chr(13)
	...
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 150 vlan-scope local network-vlan stacked:300:150" & chr(13)
