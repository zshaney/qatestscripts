...
Sub Main
	...
	'delete service vpls
	crt.Screen.Send "configure  service  vpls 150   shutdown" & chr(13)
	crt.Screen.Send "configure  service   vpls  150  sap  lt:1/1/5:150  shutdown" & chr(13)
	crt.Screen.Send "configure   service  vpls  150  no sap  lt:1/1/5:150" & chr(13)
	crt.Screen.Send "configure  service  vpls 150  sap  nt-a:xfp:1:150 shutdown" & chr(13)
	crt.Screen.Send "configure  service  vpls  150 no sap nt-a:xfp:1:150" & chr(13)
	crt.Screen.Send "configure  service   no  vpls  150" & chr(13)
	...
	crt.Screen.Send "configure service vpls 150 v-vpls vlan 150 customer 1 create" & chr(13)
	crt.Screen.Send "configure service vpls 150 sap lt:1/1/5:150 create" & chr(13)
	crt.Screen.Send "configure service vpls 150 sap nt-a:xfp:1:150 create" & chr(13)
	crt.Screen.Send "configure service vpls 150 no shutdown" & chr(13)
	
	crt.Screen.Send "configure vlan id stacked:300:0 mode cross-connect in-qos-prof-name name:Default_TC0" & chr(13)
	crt.Screen.Send "configure vlan id 150 mode residential-bridge in-qos-prof-name name:Default_TC0" & chr(13)
	...
	crt.Screen.Send "configure bridge port " & portid & " vlan-id stacked:300:0" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " pvid stacked:300:0 default-priority 3" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 150" & chr(13)
