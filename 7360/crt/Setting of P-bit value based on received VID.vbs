...
Sub Main
	...
	crt.Screen.Send "configure vlan priority-regen 15 profile-name PBIT2TO0 pbit2 0" & chr(13)
	crt.Screen.Send "configure vlan priority-regen 16 profile-name PBIT2TO1 pbit2 1" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 100 qos profile:15" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 200 qos profile:16" & chr(13)
