...
Sub Main
	...
	crt.Screen.Send "configure vlan priority-regen 18 profile-name PBIT0TO1 pbit0 1" & chr(13)
	crt.Screen.Send "configure vlan priority-regen 19 profile-name PBIT0TO3 pbit0 3" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 100 qos profile:18" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 200 qos profile:19" & chr(13)
