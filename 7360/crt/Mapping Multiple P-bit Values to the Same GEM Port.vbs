...
Sub Main
	...
	crt.Screen.Send "configure  service  vpls 200   shutdown" & chr(13)
	crt.Screen.Send "configure  service   vpls  200  sap  lt:1/1/5:200  shutdown" & chr(13)
	crt.Screen.Send "configure   service  vpls  200  no sap  lt:1/1/5:200" & chr(13)
	crt.Screen.Send "configure  service  vpls 200  sap  nt-a:xfp:1:200 shutdown" & chr(13)
	crt.Screen.Send "configure  service  vpls  200 no sap nt-a:xfp:1:200" & chr(13)
	crt.Screen.Send "configure  service   no  vpls  200" & chr(13)	
	...
	crt.Screen.Send "configure service vpls 200 v-vpls vlan 200 customer 1 create" & chr(13)
	crt.Screen.Send "configure service vpls 200 sap lt:1/1/5:200 create" & chr(13)
	crt.Screen.Send "configure service vpls 200 sap nt-a:xfp:1:200 create" & chr(13)
	crt.Screen.Send "configure service vpls 200 no shutdown" & chr(13)
	crt.Screen.Send "configure vlan id 200 mode residential-bridge in-qos-prof-name name:Default_TC0" & chr(13)
	...
	crt.Screen.Send "configure vlan priority-regen 21 profile-name PBIT1TO12TO2 pbit1 1 pbit2 2" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 100 qos profile:21" & chr(13)
	crt.Screen.Send "configure vlan priority-regen 23 profile-name PBIT3TO34TO4 pbit3 3 pbit4 4" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 200 qos profile:23" & chr(13)
