...
Sub Main
	...
	crt.Screen.Send "configure vlan priority-regen 11 profile-name PBIT1TO1 pbit1 1" & chr(13)
	crt.Screen.Send "configure vlan priority-regen 12 profile-name PBIT1TO1 pbit1 2" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 100 qos profile:11" & chr(13)
	crt.Screen.Send "configure bridge port " & portid & " vlan-id 200 qos profile:12" & chr(13)
