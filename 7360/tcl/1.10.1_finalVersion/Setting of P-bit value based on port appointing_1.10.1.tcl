...
set da1 "00 09 10 00 01 01"
set sa1 "00 09 10 00 02 01"
set da2 "00 09 10 00 01 02"
set sa2 "00 09 10 00 02 02"
set da3 "00 09 10 00 01 03"
set sa3 "00 09 10 00 02 03"
set da4 "00 09 10 00 01 04"
set sa4 "00 09 10 00 02 04"
...
if {$Mark1 == 10} {
    ixPuts "error ! not receiving Vlan=100 Priority =0 upstream stream1"
}
...
if {$Mark2 == 10} {
    ixPuts "error ! not receiving Vlan=100 Priority =1 upstream stream2"
}
...
if {$Mark3 == 10} {
    ixPuts "error ! not receiving  Vlan=100 Priority =0 downstream stream"
}
...
for {set s 1} {$s <= 10} {incr s} {
	if { [captureBuffer getframe $s] } {
	   ...
	   break
		...
		set capFrame [captureBuffer cget -frame]
		set typeField [lrange $capFrame 0 15]
		set tarValue [format "%s %s 81 00 20 C8" $sa2 $da2 ]
		if {$typeField == $tarValue} {
		   incr Flag4
		   ixPuts  "It is expected that receiving a Vlan=200 Priority =1 downstream stream2 ."
		   break
		} else { 
		     puts $typeField
		     incr Mark4
...
if {$Mark4 == 10} {
    ixPuts "error ! not receiving  Vlan=200 Priority =1 downstream stream2"
}
...
for {set p 1} {$p <= 10} {incr p} {
	if { [captureBuffer getframe $p] } {
	   ...
	   break
	     ...
	     set tarValue [format "%s %s" $sa3 $da3]
	     if {$typeField == $tarValue} {
            ixPuts "error ! receiving downstream stream3."
	        puts $typeField
	        break
	     } else { 
	           incr Mark5
...
if  {$Mark5 == 10} {
    incr Flag5
	ixPuts "It is expected that not receiving downstream stream3."
}
...
for {set q 1} {$q <= 10} {incr q} {
	if { [captureBuffer getframe $q] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 11]
	     set tarValue [format "%s %s" $sa4 $da4]
	     if {$typeField == $tarValue} {
            ixPuts "error ! receiving downstream stream4."
	        puts $typeField
	        break
	     } else { 
	           incr Mark6
...
if  {$Mark6 == 10} {
    incr Flag6
	ixPuts "It is expected that not receiving downstream stream4."
}
