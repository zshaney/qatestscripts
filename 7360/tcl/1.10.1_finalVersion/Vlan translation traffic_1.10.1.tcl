...
set da1 "00 09 00 00 01 01"
set sa1 "00 09 00 00 02 01"
set da2 "00 09 00 00 01 02"
set sa2 "00 09 00 00 02 02"
set da3 "00 09 00 00 01 03"
set sa3 "00 09 00 00 02 03"
set da4 "00 09 00 00 01 04"
set sa4 "00 09 00 00 02 04"
...
for {set i 1} {$i <= 10} {incr i} {
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	       ...
	       set tarValue [format "%s %s 81 00 21 90" $da3 $sa3 ]
	       if {$typeField == $tarValue	} {
              incr Flag1
	          ixPuts "It is expected that receiving a Vlan=400 Priority =1 stream3 from lanport."
	          break
	          } else { 
	                puts $typeField
	                incr Mark1
...
if {$Mark1 == 10} {
    ixPuts "error ! not receiving Vlan=400 Priority =1 upstream stream3"
}
...
for {set j 1} {$j <= 10} {incr j} {
	...
	break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 41 90" $da4 $sa4 ]
	     if {$typeField == $tarValue} {
            incr Flag2
	        ixPuts "It is expected that receiving a Vlan=400 Priority =2 stream4 from lanport."
	     break
	     } else { 
	           puts $typeField
	           incr Mark2
...
if {$Mark2 == 10} {
    ixPuts "error ! not receiving Vlan=400 Priority =2 upstream stream4"
}
...
for {set r 1} {$r <= 10} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
		...
		if {$typeField == $tarValue} {
		   incr Flag5
		   ixPuts  "It is expected that receiving a Vlan=200 Priority =0 stream from wanport."
		   break
		} else { 
		     puts $typeField
		     incr Mark5
...
if {$Mark5 == 10} {
    ixPuts "error ! not receiving  Vlan=200 Priority =0 downstream stream"
}
