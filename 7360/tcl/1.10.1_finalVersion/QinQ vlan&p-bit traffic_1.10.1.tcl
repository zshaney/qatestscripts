...
set da1 "00 09 04 00 01 01"
set sa1 "00 09 04 00 02 01"
set da2 "00 09 04 00 01 02"
set sa2 "00 09 04 00 02 02"
set da3 "00 09 04 00 01 03"
set sa3 "00 09 04 00 02 03"
set da4 "00 09 04 00 01 04"
set sa4 "00 09 04 00 02 04"
...
for {set i 1} {$i <= 10} {incr i} {
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	       ...
	       set tarValue [format "%s %s 81 00 41 2C 81 00 40 96" $da3 $sa3 ]
	       if {$typeField == $tarValue	} {
              incr Flag1
	          ixPuts "It is expected that receiving a outerVlan=300&Priority=2 innerVLan=150&priority=2 upstream stream3 ."
	          break
	          } else { 
	                puts $typeField
	                incr Mark1
...
if {$Mark1 == 10} {
    ixPuts "error ! not receiving outerVlan=300&Priority=2 innerVLan=150&priority=2 upstream stream3"
}
...
for {set r 1} {$r <= 10} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
		...
		if {$typeField == $tarValue} {
		   incr Flag5
		   ixPuts  "It is expected that receiving a Vlan=150 Priority =1 downstream stream ."
		   break
		} else { 
		     puts $typeField
		     incr Mark5
...
if {$Mark5 == 10} {
    ixPuts "error ! not receiving  Vlan=150 Priority =1 downstream stream"
}
