...
set da1 "00 09 05 00 01 01"
set sa1 "00 09 05 00 02 01"
set da2 "00 09 05 00 01 02"
set sa2 "00 09 05 00 02 02"
set da3 "00 09 05 00 01 03"
set sa3 "00 09 05 00 02 03"
set da4 "00 09 05 00 01 04"
set sa4 "00 09 05 00 02 04"
...
for {set j 1} {$j <= 10} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 60 C8" $da3 $sa3 ]
	     if {$typeField == $tarValue} {
            incr Flag2
	        ixPuts "It is expected that receiving a Vlan=200 Priority =3 upstream stream3 ."
	     break
	     } else { 
	           puts $typeField
	           incr Mark2
...
if {$Mark2 == 10} {
    ixPuts "error ! not receiving Vlan=200 Priority =3 upstream stream3"
}
...
for {set m 1} {$m <= 10} {incr m} {
	if { [captureBuffer getframe $m] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 11]
	     set tarValue [format "%s %s " $da4 $sa4]
	     if {$typeField == $tarValue} {
            ixPuts "error ! receiving upstream stream4."
	        puts $typeField
	        break
	     } else { 
	          incr Mark4
...
if  {$Mark4 == 10} {
    incr Flag4
	ixPuts "It is expected that not receiving upstream stream4."
}
...
for {set r 1} {$r <= 10} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
		...
		set capFrame [captureBuffer cget -frame]
		set typeField [lrange $capFrame 0 15]
		set tarValue [format "%s %s 81 00 00 64" $sa1 $da1 ]
		if {$typeField == $tarValue} {
		   incr Flag5
		   ixPuts  "It is expected that receiving a Vlan=100 Priority =0 downstream stream1 ."
		   break
		} else { 
		     puts $typeField
		     incr Mark5
...
if {$Mark5 == 10} {
    ixPuts "error ! not receiving  Vlan=100 Priority =0 downstream stream1"
}
...
for {set s 1} {$s <= 10} {incr s} {
	if { [captureBuffer getframe $s] } {
	   ...
	   break
		...
		set capFrame [captureBuffer cget -frame]
		set typeField [lrange $capFrame 0 15]
		set tarValue [format "%s %s 81 00 00 C8" $sa3 $da3 ]
		if {$typeField == $tarValue} {
		   incr Flag6
		   ixPuts  "It is expected that receiving a Vlan=200 Priority =0 downstream stream3 ."
		   break
		} else { 
		     puts $typeField
		     incr Mark6
...
if {$Mark6 == 10} {
    ixPuts "error ! not receiving  Vlan=200 Priority =0 downstream stream3. "
}
