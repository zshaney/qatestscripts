...
set da1 "00 09 11 00 01 01"
set sa1 "00 09 11 00 02 01"
set da2 "00 09 11 00 01 02"
set sa2 "00 09 11 00 02 02"
set da3 "00 09 11 00 01 03"
set sa3 "00 09 11 00 02 03"
set da4 "00 09 11 00 01 04"
set sa4 "00 09 11 00 02 04"
...
for {set i 1} {$i <= 10} {incr i} {
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	       ...
	       set tarValue [format "%s %s 81 00 23 E8 81 00 21 90" $da3 $sa3 ]
	       if {$typeField == $tarValue	} {
              incr Flag1
	          ixPuts "It is expected that receiving a outerVlan=1000&Priority=1 innerVLan=400&priority=1 upstream stream3 ."
	          break
	          } else { 
	                puts $typeField
	                incr Mark1
...
if {$Mark1 == 10} {
    ixPuts "error ! not receiving outerVlan=1000&Priority=1 innerVLan=400&priority=1 upstream stream3"
}
...
for {set j 1} {$j <= 10} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 19]
	     set tarValue [format "%s %s 81 00 43 E8 81 00 41 90" $da4 $sa4 ]
	     if {$typeField == $tarValue} {
            ixPuts "It is expected that receiving a outerVlan=1000&Priority=2 innerVlan=400&priority=2 upstream stream4."
			incr Flag2
	        break
	     } else { 
	           puts $typeField
...
if {$Mark2 == 10} {
    ixPuts "error ! not receiving outerVlan=1000&Priority=2 innerVlan=400&priority=2 upstream stream4"
}
...
for {set r 1} {$r <= 10} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
		...
		set tarValue [format "%s %s 81 00 A0 C8" $sa3 $da3 ]
		if {$typeField == $tarValue} {
		   incr Flag5
		   ixPuts  "It is expected that receiving a Vlan=200 Priority =5 downstream stream ."
		   break
		} else { 
		     puts $typeField
		     incr Mark5
...
if {$Mark5 == 10} {
    ixPuts "error ! not receiving  Vlan=200 Priority =5 downstream stream"
}
