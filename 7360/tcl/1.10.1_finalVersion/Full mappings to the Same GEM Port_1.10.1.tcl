...
set da0 "00 09 0D 00 01 00"
set sa0 "00 09 0D 00 02 00"
set da1 "00 09 0D 00 01 01"
set sa1 "00 09 0D 00 02 01"
set da2 "00 09 0D 00 01 02"
set sa2 "00 09 0D 00 02 02"
set da3 "00 09 0D 00 01 03"
set sa3 "00 09 0D 00 02 03"
set da4 "00 09 0D 00 01 04"
set sa4 "00 09 0D 00 02 04"
set da5 "00 09 0D 00 01 05"
set sa5 "00 09 0D 00 02 05"
set da6 "00 09 0D 00 01 06"
set sa6 "00 09 0D 00 02 06"
set da7 "00 09 0D 00 01 07"
set sa7 "00 09 0D 00 02 07"
...
stream                       config            -numDA                              8
stream                       config            -numSA                              8
...
stream                       config            -rateMode                           usePercentRate
stream                       config            -preambleSize                       8
stream                       config            -sa                                 $da0
stream                       config            -saRepeatCounter                    increment
stream                       config            -saStep                             1
stream                       config            -saMaskValue                        "00 00 00 00 00 00"
stream                       config            -saMaskSelect                       "00 00 00 00 00 00"
stream                       config            -enableSaContinueFromLastValue      false
stream                       config            -da                                 $sa0
stream                       config            -daRepeatCounter                    increment
stream                       config            -daStep                             1
stream                       config            -daMaskValue                        "00 00 00 00 00 00"
stream                       config            -daMaskSelect                       "00 00 00 00 00 00"
...
for {set i 1} {$i <= 20} {incr i} {
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	       ...
	       set tarValue [format "%s %s 81 00 20 64" $da0 $sa0 ]
...
for {set j 1} {$j <= 20} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 65" $da1 $sa1 ]
	     if {$typeField == $tarValue} {
            incr Flag2
...
for {set k 1} {$k <= 20} {incr k} {
	if { [captureBuffer getframe $k] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 66" $da2 $sa2]
	     if {$typeField == $tarValue} {
            incr Flag3
...
for {set m 1} {$m <= 20} {incr m} {
	if { [captureBuffer getframe $m] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 67" $da3 $sa3]
	     if {$typeField == $tarValue} {
            incr Flag4
...
for {set n 1} {$n <= 20} {incr n} {
	if { [captureBuffer getframe $n] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 68" $da4 $sa4]
	     if {$typeField == $tarValue} {
            incr Flag5
...
for {set p 1} {$p <= 20} {incr p} {
	if { [captureBuffer getframe $p] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 69" $da5 $sa5]
	     if {$typeField == $tarValue} {
            incr Flag6
...
for {set q 1} {$q <= 20} {incr q} {
	if { [captureBuffer getframe $q] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 6A" $da6 $sa6]
	     if {$typeField == $tarValue} {
            incr Flag7
...
for {set r 1} {$r <= 20} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 6B" $da7 $sa7]
	     if {$typeField == $tarValue} {
            incr Flag8
...
captureBuffer get $chassis $card $lanport 1 20
...
for {set i 1} {$i <= 20} {incr i} {
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	       ...
	       set capFrame [captureBuffer cget -frame]
	       set typeField [lrange $capFrame 0 15]
	       set tarValue [format "%s %s 81 00 20 64" $sa0 $da0 ]
	       if {$typeField == $tarValue	} {
              incr Flag9
...
for {set j 1} {$j <= 20} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 65" $sa1 $da1 ]
	     if {$typeField == $tarValue} {
            incr Flag10
...
for {set k 1} {$k <= 20} {incr k} {
	if { [captureBuffer getframe $k] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 66" $sa2 $da2]
	     if {$typeField == $tarValue} {
            incr Flag11
...
for {set m 1} {$m <= 20} {incr m} {
	if { [captureBuffer getframe $m] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 67" $sa3 $da3]
	     if {$typeField == $tarValue} {
            incr Flag12
...
for {set n 1} {$n <= 20} {incr n} {
	if { [captureBuffer getframe $n] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 68" $sa4 $da4]
	     if {$typeField == $tarValue} {
            incr Flag13
...
for {set p 1} {$p <= 20} {incr p} {
	if { [captureBuffer getframe $p] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 69" $sa5 $da5]
	     if {$typeField == $tarValue} {
            incr Flag14
...
for {set q 1} {$q <= 20} {incr q} {
	if { [captureBuffer getframe $q] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 6A" $sa6 $da6]
	     if {$typeField == $tarValue} {
            incr Flag15
...
for {set r 1} {$r <= 20} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 6B" $sa7 $da7]
	     if {$typeField == $tarValue} {
            incr Flag16
