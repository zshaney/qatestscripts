...
set da1 "00 09 02 00 01 01"
set sa1 "00 09 02 00 02 01"
set da2 "00 09 02 00 01 02"
set sa2 "00 09 02 00 02 02"
set da3 "00 09 02 00 01 03"
set sa3 "00 09 02 00 02 03"
set da4 "00 09 02 00 01 04"
set sa4 "00 09 02 00 02 04"
...
for {set j 1} {$j <= 10} {incr j} {
	...
	break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 20 C8" $da2 $sa2 ]
	     if {$typeField == $tarValue} {
            incr Flag2
	        ixPuts "It is expected that receiving a Vlan=200 Priority =1 upstream stream2."
	     break
	     } else { 
	           puts $typeField
	           incr Mark2
...
if {$Mark2 == 10} {
    ixPuts "error ! not receiving Vlan=200 Priority =1 upstream stream2"
}
...
for {set s 1} {$s <= 10} {incr s} {
	if { [captureBuffer getframe $s] } {
	   ...
	   break
		...
		set capFrame [captureBuffer cget -frame]
		set typeField [lrange $capFrame 0 15]
		set tarValue [format "%s %s 81 00 40 C8" $sa2 $da2 ]
		if {$typeField == $tarValue} {
		   incr Flag4
