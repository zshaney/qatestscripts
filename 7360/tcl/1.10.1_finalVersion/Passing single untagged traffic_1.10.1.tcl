...
set da1 "00 09 06 00 01 01"
set sa1 "00 09 06 00 02 01"
set da2 "00 09 06 00 01 02"
set sa2 "00 09 06 00 02 02"
set da3 "00 09 06 00 01 03"
set sa3 "00 09 06 00 02 03"
set da4 "00 09 06 00 01 04"
set sa4 "00 09 06 00 02 04"
...
for {set i 1} {$i <= 10} {incr i} {
	if { [captureBuffer getframe $i] } {
	   ...
	   break
	       ...
	       set tarValue [format "%s %s 81 00 A3 E8" $da1 $sa1 ]
...
for {set j 1} {$j <= 10} {incr j} {
	if { [captureBuffer getframe $j] } {
	    ...
	    break
	     ...
	     set capFrame [captureBuffer cget -frame]
	     set typeField [lrange $capFrame 0 15]
	     set tarValue [format "%s %s 81 00 03 E8" $da2 $sa2 ]
	     if {$typeField == $tarValue} {
            incr Flag2
...
for {set k 1} {$k <= 10} {incr k} {
	...
	# assert that  the packets tagged with vlan2000 not forwarding
	     ...
	     set tarValue [format "%s %s" $da3 $sa3]
	     if {$typeField == $tarValue} {
...
for {set r 1} {$r <= 10} {incr r} {
	if { [captureBuffer getframe $r] } {
	   ...
	   break
		...
		set tarValue1 [format "%s %s" $sa1 $da1]
